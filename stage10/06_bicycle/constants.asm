...
%include "maps/southside2.inc"   ; 10.03: the map with sites and pairs
WORLD_W  equ MAP_W
WORLD_H  equ MAP_H
...
PLAYER_DAMAGE        equ 34   ; a pistol hit (soldiers: 20): three kill
