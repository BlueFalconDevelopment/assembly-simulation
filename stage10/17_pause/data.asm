...
section .data
    ...
    player_rng    dq 0
    player_ammo   times 6 dd 0    ; by PW_ weapon, from 1 (weapons.asm, 10.16): pistol,
                                  ; shotgun, SMG, rifle, grenades, the bat (1: yours)
    player_weapon dd 0            ; a PW_ weapon
    player_kills  dd 0
...
%endmacro
    ...
    GLYPH_BLANK 59
    GLYPH '<', 00010b, 00100b, 01000b, 10000b, 01000b, 00100b, 00010b   ; (10.17)
    GLYPH_BLANK 61
