...
%include "maps/southside5.inc"   ; 10.07: sites, pairs and delivery points
WORLD_W  equ MAP_W
WORLD_H  equ MAP_H
...
FACTION_BIKERS equ 4          ; the Bikers (10.14): the gangs and you
...
BIKERS         equ 5                   ; the Bikers' pack (10.14)
FIRST_BIKER    equ SQUAD + 3               ; ... their slots, after yours
TOTAL_SOLDIERS equ SQUAD + 3 + BIKERS
SOLDIER_SIZE   equ 16
MOVE_SPEED     equ 2
