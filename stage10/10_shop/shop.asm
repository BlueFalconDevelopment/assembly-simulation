...
; through. Only you wear armor (player_armor % gets through); everyone
; else takes it all. Every hit on a soldier goes through here:
...
SHOP_LIST   equ 0
SHOP_ROW_W  equ 32            ; every row the same width, so they line up
