...
section .data
    ...
    home      dd 0, 1         ; complex per gang: 0 = west, 1 = east
    ...
    hostility:
        ;   Cr Bl  .  .  .  .  .  .
        db  0, 1, 0, 0, 0, 0, 0, 0      ; Crips
        db  1, 0, 0, 0, 0, 0, 0, 0      ; Bloods
        times (MAX_FACTIONS - 2) * MAX_FACTIONS db 0
